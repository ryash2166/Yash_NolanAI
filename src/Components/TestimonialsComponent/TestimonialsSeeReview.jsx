      ...
      <div className="flex justify-center items-center relative h-[400px] flex-grow-[0.5] flex-shrink basis-0">
        ...
        <div className="text-white flex-1 gap-8 flex-col pr-[30px] max-sm:pr-0">
            <div>
                ...
                <h2 className="text-[14px] mt-2 tracking-[1px] font-normal text-[#ffffff70]">{review.title}</h2>
            </div>
            <div>
                <div className="text-[#f5f2f0]">
                    <p className="text-[17px] leading-8 font-light">{review.review_1}</p>
                    <p className="text-[17px] leading-8 font-light">{review.review_2}</p>
                    <p className="text-[17px] leading-8 font-light">{review.review_3}</p>
                    <p className="text-[17px] leading-8 font-light">{review.review_4}</p>
                </div>
            </div>
