        ...
        <div className="relative h-full max-sm:relative">
          ...
          <div className="min-h-60 flex items-center pb-8 px-16 pt-16 max-sm:pt-0 max-sm:px-0 max-sm:pb-8">
            <div className="z-[1] w-full max-sm:text-center max-sm:mt-[100px]">
              <h1 className="text-[32px] font-bold uppercase -tracking-[0.04em]">
                about us
              </h1>
              <h3 className="m-0 -tracking-[0.04em] text-[40px] font-light max-lg:text-[28px] ">
                industry's
                <span className="text-[64px] font-bold max-sm:text-5xl">
                  {" "}
                  largest
                </span>
                <br />
      ...
      <div className="flex justify-center items-center rleative ">
        <div className="px-[176px] mb-5 text-[#f5f2f0] max-sm:p-4 ">
          ...
          <p className="leading-8 text-[17px] font-light">
            Our mission is to empower filmmakers at every stage of
            pre-production with advanced AI-driven tools, enhancing creativity
            and efficiency while maintaining your unique vision.
          </p>
          <p className="leading-8 text-[17px] font-light">
          ...
          <h3 className="text-[40px] max-sm:text-[32px] mt-6 mb-2 font-bold break-words">
            1. Leading the Charge in Ethical AI:
          </h3>
          <p className="leading-8 text-[17px] font-light">
            ...
            collaborate with users, ensuring that AI serves as a co-creator
            rather than a replacement.
          </p>
          <h3 className="text-[40px] max-sm:text-[32px] mt-6 mb-2 font-bold break-words">
            2. Empowering Creatives:
          </h3>
          <p className="leading-8 text-[17px] font-light">
          ...
          <p className="leading-8 text-[17px] font-light">
            ...
            production deliverables. We are expanding our capabilities to
            include budgeting, sales, and distribution, making us the only
            platform that supports filmmakers through the entire production
            lifecycle.
          </p>
          <h3 className="text-[40px] max-sm:text-[32px] mt-6 mb-2 font-bold break-words">
            4. Future Expansion:
          ...
          <h3 className="text-[40px] max-sm:text-[32px] mt-6 mb-2 font-bold break-words">
            5. Empowering Creatives with Control:
          </h3>
          <p className="leading-8 text-[17px] font-light">
            We are committed to placing power back in the hands of creatives.
            NolanAI enables filmmakers to create materials, book gigs, sell
            their work, and retain rights and control over their creations,
            fostering a more autonomous and empowered creative community.
          </p>
          <h3 className="text-[40px] max-sm:text-[32px] mt-6 mb-2 font-bold break-words">
          ...
          <p className="leading-8 text-[17px] font-light">
            ...
            focus is to eliminate inefficiencies and corruption. We aim to
            create a more transparent, efficient, and fair system for all
            stakeholders in the film industry as well as other media industries.
          </p>
          <h3 className="text-[40px] max-sm:text-[32px] mt-6 mb-2 font-bold break-words">
            7. Cost-Effective Content Creation:
          </h3>
          <p className="leading-8 text-[17px] font-light">
            NolanAI's tools are designed to increase content creation while
            minimizing costs. By providing comprehensive solutions that cover
            all aspects of film production, we help filmmakers bring their
            visions to life more affordably and efficiently.
          </p>
          <h3 className="text-[40px] max-sm:text-[32px] mt-6 mb-2 font-bold break-words">
            <b className="font-bold">
          ...
          <ul className="pl-10 list-[circle]">
            ...
            <li>
              ...
              <p className="leading-8 text-[17px] font-light">
                {" "}
                Visual planning tools to bring your scenes to life.
              </p>
            </li>
            <li>
              <p className="leading-8 text-[17px] font-light">
              ...
              <p className="leading-8 text-[17px] font-light">
                {" "}
                Efficient management of production logistics.
              </p>
            </li>
            <li>
              <p className="leading-8 text-[17px] font-light">
              ...
              <p className="leading-8 text-[17px] font-light">
                {" "}
                Tools to track and manage your production budget.
              </p>
            </li>
            <li>
              <p className="leading-8 text-[17px] font-light">
            ...
            <li>
              ...
              <p className="leading-8 text-[17px] font-light">
                {" "}
                Seamless teamwork capabilities, whether remote or on-site.
              </p>
            </li>
            <li>
              <p className="leading-8 text-[17px] font-light">
            ...
            <li>
              ...
              <p className="leading-8 text-[17px] font-light">
                {" "}
                AI-driven plot hole detection to ensure story coherence.
              </p>
            </li>
            <li>
              <p className="leading-8 text-[17px] font-light">
              ...
              <p className="leading-8 text-[17px] font-light">
                Comprehensive support options, including community support,
                email support for Basic plans, and priority support for Pro
                plans.
              </p>
            </li>
          </ul>
          ...
          <p className="leading-8 text-[17px] font-light">
            ...
            <a
              className="text-[#057ffa] hover:text-[#66a1db] duration-300 ease-in"
              href="mailto:hello@nolanai.app"
            >
              hello@nolanai.app{" "}
            </a>
            ...
            <a
              className="text-[#057ffa] hover:text-[#66a1db] duration-300 ease-in"
              href="mailto:support@nolanai.app"
            >
